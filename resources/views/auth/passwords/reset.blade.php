						...
						<div class="login-form login-signin">
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
								...
								<div class="pb-13 pt-lg-0 pt-5">
                                    <a href="{{ route('login') }}"><img width="160" src="{{ asset('images/logo-blue.png') }}"></a>
                                    <h3 class="font-weight-bolder font-size-h4 font-size-h3-lg mt-12">Reset Password</h3>
                                </div>
								<!--begin::Title-->
								<!--begin::Form group-->
								<div class="form-group">
									<input placeholder="Email" readonly id="login_email" value="{{ $email ?? old('email') }}" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6 @error('email') is-invalid @enderror" required type="email" name="email" autocomplete="off" />
                                    @error('email')
                                ...
                                <div class="form-group">
									<input id="login_email" autofocus placeholder="Password" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6 @error('password') is-invalid @enderror" pattern=".{8,}" required title="8 characters minimum" type="password" name="password" autocomplete="off" />
                                    @error('password')
                                        <span class="invalid-feedback pl-3" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
									<input id="login_email" placeholder="Confirm Password" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="password" name="password_confirmation" pattern=".{8,}" required title="8 characters minimum" autocomplete="off" />
                                </div>
								...
								<div class="form-group d-flex flex-wrap pb-lg-0">
									...
									<a href="{{ route('login') }}" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Go to Login</a>
								</div>
								<!--end::Action-->
							</form>
                            <!--end::Form-->
