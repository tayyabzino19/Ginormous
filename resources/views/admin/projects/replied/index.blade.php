...
<div class="container">
    ...
    <form id="filter_form" method="get">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="">
                ...
                <a href="{{ route('admin.projects.replied') }}" id="kt_reset">
                    <span>
    ...
    <div class="row mt-6">
        ...
        @endphp
        <div class="col-lg-12">
            <div class="card card-custom card-stretch gutter-b feed_card" data-link="{{ route('admin.projects.replied.details', $project->id) }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-1 d-flex align-items-center justify-content-center">
                            <div>
                                ...
                                <br />
                                <br />
                                <div class="symbol symbol-circle symbol-lg-35" data-toggle="tooltip" data-html="true" title="<b>Replied By:</b> {{ $project->ProjectDetail->employer_public_name }}">
