...
<div class="container">
    ...
    <form id="filter_form" method="get">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="">
                ...
                <a href="{{ route('admin.projects.bidded') }}" id="kt_reset">
                    <span>
    ...
    <div class="row mt-6">
        ...
        @endphp
        <div class="col-lg-12">
            <div class="card card-custom card-stretch gutter-b feed_card" data-link="{{ route('admin.projects.bidded.details', $project->id) }}">
                <div class="card-body">
                    <div class="row">
