 <!--begin::Modal-->
 <div class="modal fade" id="edit_tech_star_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <form id="edit_tech_star_form" method="post" action="{{ route('admin.helpers.tech_star.update') }}">
            @csrf
            <input type="hidden" name="id">
            <input type="hidden" name="status" value="inactive">

                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Tech Star</h5>
                ...
                <div class="modal-footer">
                    <div>
                        <button type="button" class="btn btn-danger btn-sm btn_delete_tech_star"><i class="icon-xl la la-trash"></i>Delete</button>
