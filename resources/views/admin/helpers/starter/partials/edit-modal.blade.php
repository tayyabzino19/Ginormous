 <!--begin::Modal-->
 <div class="modal fade" id="edit_starter_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <form id="edit_starter_form" method="post" action="{{ route('admin.helpers.starter.update') }}">
                @csrf
                <input type="hidden" name="status" value="inactive">
                <input type="hidden" name="id">

                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Starter</h5>
                ...
                <div class="modal-footer">
                    <div>
                        <button type="button" class="btn btn-danger btn-sm btn_delete_starter"><i class="icon-xl la la-trash"></i>Delete</button>
