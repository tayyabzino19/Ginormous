                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                    ...
                                    <ul class="navi navi-hover py-4">
                                        <!--begin::Item-->
                                        <li class="navi-item">
                                            <a href="{{ route('admin.settings.profile') }}" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
														<i class="fa fa-user-circle header_user_icon"></i>
													</span>
                                                <span class="navi-text user_profile">Profile</i></span>
                                            </a>
                                        </li>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            Made with <img width="22" src="{{ asset('images/heart.gif') }}"> by <a href="https://zinormous.com" target="_blank" class="text-dark-75 text-hover-primary">Zinormous</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Nav-->
                        <div class="nav nav-dark">
                            &copy; All rights reserved by&nbsp;<a class="text-dark-75 text-hover-primary" href="">Ginormous</a>
                        </div>
                        <!--end::Nav-->
                    </div>
                    <!--end::Container-->
