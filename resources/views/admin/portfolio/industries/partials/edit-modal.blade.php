<!--begin::Modal-->
<div class="modal fade" id="edit_industry_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <form id="edit_industry_form" method="post" action="{{ route('admin.portfolio.industries.update') }}">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group float-left w-100">
                                ...
                                <input type="text" required name="name" class="form-control" placeholder="Enter industry here">
                            </div>
                        </div>
                    </div>
                </div>
